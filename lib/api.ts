...
class ApiClient {
  ...
  async createMenuItem(name: string, price: number, category: string, file: File): Promise<MenuItem> {
    const formData = new FormData();
  ...
  async updateMenuItem(id: string, data: Partial<MenuItem>, file?: File): Promise<MenuItem> {
    const formData = new FormData();
